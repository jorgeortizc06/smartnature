function loadTipoSensores() {
    $('#table_tipo_sensores').DataTable({
        ...
        columnDefs: [ //Por columna lo puedes personalizar
            {
                ...
                render: function (data, type, row) {
                    ...
                    var buttons = '<a href="/gestion-riego/tipo-sensores/update/' + row.id + '/" class="btn btn-primary"><i class="fas fa-edit"></i></a> ';
                    //buttons += '<a href="/gestion-riego/tipo-sensores/delete/' + row.id + '/" class="btn btn-danger" ><i class="fas fa-trash-alt"></i></a>'
                    return buttons;
                }
            },
        ],
