        ...
        columnDefs: [ //Por columna lo puedes personalizar
            {
                ...
                render: function (data, type, row) {
                    ...
                    var buttons = '<a href="/gestion_riego/plataforma_update/' + row.id + '/" class="btn btn-primary"><i class="fas fa-edit"></i></a> ';
                    buttons += '<a href="/gestion_riego/plataforma_delete/' + row.id + '/" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>'
                    return buttons;
                }
            },
        ],
