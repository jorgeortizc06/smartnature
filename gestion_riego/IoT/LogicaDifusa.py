...
class LogicaDifusa:
    ...
    def fuzzy_logic_1_variables(self, par_humedad_suelo):
        try:
    ...
    def fuzzy_logic_4_variables(self, par_humedad_suelo, par_humedad_ambiental, par_temperatura_ambiental, par_evapo):
        try:
            humedad_suelo = ctrl.Antecedent(np.arange(0, 1024, 1), 'humedad_suelo')
            temperatura_ambiental = ctrl.Antecedent(np.arange(5, 46, 1), 'temperatura_ambiental')
            humedad_ambiental = ctrl.Antecedent(np.arange(0, 101, 1), 'humedad_ambiental')
    ...
    def fuzzy_logic_1_variables_image(self, par_humedad_suelo, id_historial_riego):
        try:
            humedad_suelo = ctrl.Antecedent(np.arange(0, 1024, 1), 'humedad_suelo')
            tiempo_riego = ctrl.Consequent(np.arange(-2, 18, 1), 'tiempo_riego')
    ...
    def fuzzy_logic_3_variables_image(self, par_humedad_suelo, par_humedad_ambiental, par_temperatura_ambiental,
                                      id_historial_riego):
        try:
            humedad_suelo = ctrl.Antecedent(np.arange(0, 1024, 1), 'humedad_suelo')
            temperatura_ambiental = ctrl.Antecedent(np.arange(5, 46, 1), 'temperatura_ambiental')
    ...
    def fuzzy_logic_4_variables_image(self, par_humedad_suelo, par_humedad_ambiental, par_temperatura_ambiental,
                                      par_evapo,
                                      id_historial_riego):
        try:
            humedad_suelo = ctrl.Antecedent(np.arange(0, 1024, 1), 'humedad_suelo')
...
# Procesa datos de los sensores del dispositivo
