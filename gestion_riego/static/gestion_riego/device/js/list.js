        ...
        columnDefs: [ //Por columna lo puedes personalizar
            {
                ...
                render: function(data, type, row) {
                    ...
                    var buttons = '<a href="/gestion_riego/device_update/' + row.id + '/" class="btn btn-secondary btnEdit"><i class="fas fa-edit"></i></a> ';
                    buttons += '<a href="/gestion_riego/persona_delete/' + row.id + '/" rel="btnDelete" class="btn btn-secondary"><i class="fas fa-trash-alt"></i></a>'
                    return buttons;
                }
            },
        ],
