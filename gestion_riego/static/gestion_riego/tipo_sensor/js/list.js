        ...
        columnDefs: [ //Por columna lo puedes personalizar
            {
                ...
                render: function (data, type, row) {
                    ...
                    var buttons = '<a href="/gestion_riego/tipo_sensor_update/' + row.id + '/" class="btn btn-secondary"><i class="fas fa-edit"></i></a> ';
                    buttons += '<a href="/gestion_riego/tipo_sensor_delete/' + row.id + '/" class="btn btn-secondary"><i class="fas fa-trash-alt"></i></a>'
                    return buttons;
                }
            },
        ],
